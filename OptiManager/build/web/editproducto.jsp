...
<html lang="en">
  <head>
    ...
    <title> Editar Producto / OPTIMANAGER</title>
        ...
        <div class="col-md-5 mx-auto">
          <div id="second">
            <div class="formulario form ">
              ...
              <form method="POST" action="actuproducto.jsp?CodProducto=<%=CodProducto%>" name="crearproducto">
                ...
                <div class="col-md-12 text-center mb-3">
                  <button type="submit" class=" btn btn-block mybtn btn-info tx-tfm">Actualizar</button>
                </div>
                <div class="col-md-12 ">
                  <div class="form-group">
